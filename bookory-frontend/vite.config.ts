...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@bookory-frontend/detailpage': resolve(__dirname, 'packages/pages/detailpage/ui/index.tsx'),
      '@bookory-frontend/shelfpage': resolve(__dirname, 'packages/pages/shelfpage/ui/index.tsx'),
      ...
      '@bookory-frontend/auth-api': resolve(__dirname, 'packages/core/api/auth-api/index.ts'),
      ...
      '@bookory-frontend/bookhistory': resolve(__dirname, 'packages/core/interfaces/bookhistory/index.ts'),
      '@bookory-frontend/updateprofileform': resolve(__dirname, 'packages/core/interfaces/updateprofile-form/index.ts'),
      ...
      '@bookory-frontend/header': resolve(__dirname, 'packages/base/header/ui/index.tsx'),
    }
  }
})
